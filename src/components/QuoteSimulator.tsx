...
export default function QuoteSimulator() {
  ...
  return (
    <section className="py-20 px-6 bg-slate-900 text-slate-100 min-h-[600px] flex items-center">
      <div className="max-w-6xl mx-auto w-full bg-slate-950 border border-slate-800 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col md:flex-row">
        
        {/* Image de dégradé à gauche */}
        <div className="w-full md:w-1/3 relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 to-teal-900 opacity-90 group-hover:scale-110 transition-transform duration-500"></div>
          <img 
            src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=2070&auto=format&fit=crop" 
            alt="Formation d'équipe" 
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-black/30 flex items-center justify-center p-8 text-center flex-col gap-4">
             <div className="p-4 bg-emerald-500/10 text-emerald-400 rounded-full border border-emerald-500/20">
                <Calculator className="w-10 h-10" />
              </div>
            <h3 className="text-xl font-semibold text-white">Prêt pour votre devis ?</h3>
            <p className="text-sm text-slate-200">Suivez les étapes pour obtenir votre estimation instantanée.</p>
          </div>
        </div>
